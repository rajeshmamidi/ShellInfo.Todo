        ...
        var AjaxLoad =
            ...
            function () {
                function AjaxLoad(element, config) {
                    ...
                    if (url !== '') {
                        console.log("Reached setupURL::A")
                        this.setUpUrl(url);
                    } else {
                        console.log("Reached setupURL::B with defaultPage")
                        this.setUpUrl(this._config.defaultPage);
                    }

                    console.log("About to add eventListeners")
                ...
                _proto.loadPage = function loadPage(url) {
                    ...
                    console.log("THis is the URL 1::::" + url);

                    var serverUrl;
                    if (!url.startsWith("/")) {
                        console.log("Prefixing sub-directory")
                        serverUrl = config.subpagesDirectory + url;
                    }
                    else {
                        console.log("NOT Prefixing sub-directory")
                        serverUrl = url;
                    }
                ...
                _proto.setUpUrl = function setUpUrl(url) {
                    console.log("Reached here..setUpUrl proto about to set menu active etc and then LOADPAGE...A")
                ...
                _proto._addEventListeners = function _addEventListeners() {
                    var _this = this;
                    console.log("Attach event listener:::A")
        ...
        var AsideMenu =
            ...
            function () {
                function AsideMenu(element) {
                    this._element = element;
                    console.log("About to add EventListeners...2")
                    this._addEventListeners();
                } // Getters
        ...
        var Sidebar =
            ...
            function () {
                function Sidebar(element) {
                    ...
                    console.log("In SideBAR: About to add eventlistener")
                    this._addEventListeners();
                ...
                _proto._addClickOut = function _addClickOut() {
                    console.log("Add Click out: EventListener")
                    document.addEventListener(Event.CLICK, this._clickOutListener, true);
                };

                _proto._removeClickOut = function _removeClickOut() {
                    console.log("Remove Click out: EventListener")
                ...
                _proto._addEventListeners = function _addEventListeners() {
                    ...
                    console.log("Yet another addEventListener...9")
...
(function (global, factory) {
    ...
    */
    ...
    var AjaxLoad = function ($$$1) {
        ...
        var Default = {
            defaultDashboardPage: 'dashboard.html',
            defaultPage: 'main.html',
            errorPage: '404.html',
            subpagesDirectory: 'views/'
        };
        ...
        var AjaxLoad =
            ...
            function () {
                function AjaxLoad(element, config) {
                    console.log("Reached AjaxLoad.. About to getConfig...1")
                    this._config = this._getConfig(config);
                    this._element = element;
                    var url = location.hash.replace(/^#/, '');

                    if (url !== '') {
                        console.log("Reached setUpUrl in AjaxLoad...2")
                        this.setUpUrl(url);
                    } else if ($("#userName")!= null && $("#userName").val() == "Dashboard") {
                        console.log("Reached setUpUrl in AjaxLoad with defaultDashboardPage...3")
                        this.setUpUrl(this._config.defaultDashboardPage);
                    }
                    else {
                        console.log("Reached setUpUrl in AjaxLoad with defaultPage...4")
                        this.setUpUrl(this._config.defaultPage);
                    }

                    console.log("AjaxLoad EventListener..10")
                    this._addEventListeners();
                } // Getters
                ...
                // Public
                _proto.loadPage = function loadPage(url) {
                    console.log("Reached here.. Proto AjaxLoad.prototype...4")
                    ...
                    console.log("THis is the URL 2::::" + url);
                ...
                _proto.setUpUrl = function setUpUrl(url) {
                    console.log("Reached here..setUpUrl.. Set menu active etc., and Load page..B")
                    $$$1(Selector.NAV_LINK).removeClass(ClassName.ACTIVE);
                    $$$1(Selector.NAV_DROPDOWN).removeClass(ClassName.OPEN);
                    $$$1(Selector.NAV_DROPDOWN + ":has(a[href=\"" + url.replace(/^\//, '').split('?')[0] + "\"])").addClass(ClassName.OPEN);
                    $$$1(Selector.NAV_ITEM + " a[href=\"" + url.replace(/^\//, '').split('?')[0] + "\"]").addClass(ClassName.ACTIVE);
                ...
                _proto._addEventListeners = function _addEventListeners() {
                    ...
                    $$$1(document).on(Event.CLICK, Selector.NAV_LINK + "[href!=\"#\"]", function (event) {
                        ...
                        console.log("Adding event click listeners...1")
                        event.preventDefault();
                        event.stopPropagation();
                    ...
                    $$$1(document).on(Event.CLICK, Selector.MY_LINK + "[href!=\"#\"]", function (event) {

                        console.log("Adding event click listeners...2")
                        event.preventDefault();
                        event.stopPropagation();
